export default {
  ...
  dicts: {
    ...
    bDRFPool: {
      bDRFPool: 'bBUSD Pool',
      bDRFPoolTip: 'Stake bBUSD to earn {{APR}}% APR',
      bDRFPoolTitle: 'Deposit bBUSD to earn stable interests, or exchange bBUSD to stable coin.',
      Exchangeable: 'Exchangeable',
      Interests: 'Interests',
      ClaimAll: 'Claim All',
      Deposited: 'Deposited',
      DepositbDRF: 'Deposit bBUSD',
      WalletBalance: 'Wallet Balance',
      AmountToDeposit: 'Amount to deposit',
      Deposit: 'Deposit',
      WithdrawBDRF: 'Withdraw bBUSD',
      Withdrawable: 'Withdrawable',
      AmountToWithdraw: 'Amount to withdraw',
      Withdraw: 'Withdraw',
      ExchangeBDRF: 'Exchange bBUSD',
